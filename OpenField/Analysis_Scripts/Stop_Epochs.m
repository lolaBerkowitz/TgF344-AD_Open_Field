...
for i = 1:length(params.subID)
    ...
    % Heading Direction 
    % Head direction 
    hd = atan2(neck_y - head_y,neck_x - head_x);
    % Angular velocity 
    anglevel = insta_angvel(hd,30,0.25);
    ...
    params.inter_stop_interval{i} = [NaN;diff(events(:,3))];
    params.stop_start{i} = stop_start;
